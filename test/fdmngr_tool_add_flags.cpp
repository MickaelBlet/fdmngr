...
GTEST_TEST(fdmngr_tool_add_flags, fail) {
    using ::testing::_;
    using ::testing::Return;

    {
        EXPECT_EQ(fdmngr_tool_add_flags(66666, 0), -1);
    }
    {
        ...
        EXPECT_EQ(fdmngr_tool_add_flags(0, 0), -1);
    }
}

GTEST_TEST(fdmngr_tool_add_flags, success) {
    using ::testing::_;
    using ::testing::Return;
    ...
    MOCKF_INIT(fdmngr_tool_set_flags);
    MOCKF_EXPECT_CALL(fdmngr_tool_set_flags, (_, _)).WillOnce(Return(current_flags));
    MOCKF_GUARD(fdmngr_tool_set_flags);
    EXPECT_EQ(fdmngr_tool_add_flags(0, 0), current_flags);
}