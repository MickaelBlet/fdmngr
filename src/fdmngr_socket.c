...
static int s_fdmngr_socket_create_inet(int type, const char* ip, int port, int reuseaddr) {
...
static int s_fdmngr_socket_create_inet6(int type, const char* ip, int port, int reuseaddr) {
...
void fdmngr_socket_get_ipv4_infos(struct sockaddr_in in, uint8_t out_ip[4], uint16_t* out_port) {
